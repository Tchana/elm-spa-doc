...
var $author$project$Generated$Guide$Pages$Dynamic_Folder_Model = function (a) {
	return {$: 'Dynamic_Folder_Model', a: a};
};
var $author$project$Generated$Guide$Pages$Dynamic_Folder_Msg = function (a) {
	return {$: 'Dynamic_Folder_Msg', a: a};
};
...
var $author$project$Generated$Guide$Pages$recipes = {
	...
	dynamic_folder: $author$project$Utils$Spa$recipe(
		{page: $author$project$Generated$Docs$Dynamic$Pages$page, toModel: $author$project$Generated$Guide$Pages$Dynamic_Folder_Model, toMsg: $author$project$Generated$Guide$Pages$Dynamic_Folder_Msg})
};
var $author$project$Generated$Guide$Pages$bundle = function (bigModel) {
	if (bigModel.$ === 'DynamicModel') {
		var model = bigModel.a;
		return $author$project$Generated$Guide$Pages$recipes.dynamic.bundle(model);
	} else {
		var model = bigModel.a;
		return $author$project$Generated$Guide$Pages$recipes.dynamic_folder.bundle(model);
	}
};
var $author$project$Generated$Guide$Pages$init = function (route_) {
	if (route_.$ === 'Dynamic') {
		...
		var route = route_.b;
		return $author$project$Generated$Guide$Pages$recipes.dynamic_folder.init(route);
	}
};
		...
		while (true) {
			if (_v0.a.$ === 'DynamicMsg') {
				...
				if (_v0.b.$ === 'Dynamic_Folder_Model') {
					var msg = _v0.a.a;
					var model = _v0.b.a;
					return A2($author$project$Generated$Guide$Pages$recipes.dynamic_folder.update, msg, model);
				} else {
					break _v0$2;
				}
			}
