...
viewFooter =
    ...
    , row [ alignRight, spacing 16, Font.underline ]
        [ newTabLink [] { url = "https://package.elm-lang.org/packages/ryannhg/elm-spa/latest", label = text "the elm package" }
        , newTabLink [] { url = "https://github.com/ryannhg/elm-spa", label = text "the github repo" }
        ]
    ]